...
public class decimoPrimeiro {
    static void main(String[] args) {
        ...
        int codPecaA = input.nextInt();
        int quantPecaA = input.nextInt();
        float valorPecaA = input.nextFloat();

        int codPecaB = input.nextInt();
        int quantPecaB = input.nextInt();
        float valorPecaB = input.nextFloat();


        float totalPagar = (quantPecaA * valorPecaA) + (quantPecaB * valorPecaB);
